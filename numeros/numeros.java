...
public class numeros {
    public static void main(String[] args) {
        int n, s =0;
        String resp;
        Scanner leia = new Scanner(System.in); /*new Scanner = objeto. 

            Para criar uma classe Scanner você precisa colocar Scanner + o nome do scanner que você desejar, depois =, depois chamar o objeto new Scanner, e entre parêntesis colocar a classe de entrada(System.in);. Se fosse de saída seria System.out... ;) */ 
        do{
